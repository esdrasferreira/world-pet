...
<div class="container">
    <form method="post" action="/pets/salvar">
        <input type="hidden" name="id" id="id" value="${pet.id}">
        <div class="form-group row">
            <label for="nome" class="col-sm-2 col-form-label">Dono:</label>
            <div class="col-auto">
                <select class="custom-select" name="usuario_id">

                        <%--inicio foreach para as usuarios --%>
                        <c:forEach var="usuario" items="${usuarios}">
                            <option value="${usuario.id}">${usuario.nome}</option>
                        </c:forEach>
                        <%--final foreach para as usuarios --%>
        ...
        <div class="form-group row">
            ...
            <div class="col-auto">
                <input type="text" class="form-control" name="nome" id="nome" placeholder="" value="${pet.nome}">
            </div>
        </div>
        <div class="form-group row">
            <label for="idade" class="col-sm-2 col-form-label">Idade:</label>
            <div class="col-auto">
                <input type="date" class="form-control" name="idade" id="idade" placeholder="" value="${pet.idade}">
            </div>
        </div>
        <div class="form-group row">
            <label for="raca" class="col-sm-2 col-form-label">Raça:</label>
            <div class="col-auto">
                <input type="text" class="form-control" name="raca" id="raca" placeholder="" value="${pet.raca}">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-auto">
                <input type="texto" class="form-control" name="tipo" id="tipo" placeholder="" value="${pet.tipo}">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-10">
